<template>
  <div>
    <md-table v-model="users" @md-selected="onSelect">
      <md-table-row slot="md-table-row" slot-scope="{ item }">  <!--slot-scope="{ item }" md-selectable="multiple" md-auto-select-->
        <md-table-cell md-label="Titles">{{ item.name }}</md-table-cell>
